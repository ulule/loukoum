...
func TestParse_Select(t *testing.T) {
...

	{
		...
		is.Empty(query.Columns[0].Alias)
	...
	}
	{
		...
		is.Empty(query.Columns[1].Alias)
		is.Equal("c", query.Columns[2].Name)
		is.Empty(query.Columns[2].Alias)
		is.False(query.From.Only)
		is.Equal("table", query.From.Table.Name)
		is.Empty(query.From.Table.Alias)
		is.Len(query.Joins, 0)
	...
	}
	{
		...
		is.Empty(query.Columns[3].Alias)
		is.Equal("e", query.Columns[4].Name)
		is.Empty(query.Columns[4].Alias)
		is.Equal("f", query.Columns[5].Name)
		is.Empty(query.Columns[5].Alias)
		is.False(query.From.Only)
		is.Equal("table", query.From.Table.Name)
	...
	}
	{
		...
		is.False(query.Distinct)
		is.Len(query.Columns, 1)
		is.Equal("true", query.Columns[0].Name)
		is.Empty(query.Columns[0].Alias)
		is.False(query.From.Only)
	...
	}
	{
		...
		is.False(query.Distinct)
		is.Len(query.Columns, 1)
		is.Equal("id", query.Columns[0].Name)
		is.Empty(query.Columns[0].Alias)
		is.False(query.From.Only)
		is.Equal("table", query.From.Table.Name)
		is.Empty(query.From.Table.Alias)
